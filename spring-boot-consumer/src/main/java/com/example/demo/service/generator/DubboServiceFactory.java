...
public class DubboServiceFactory {
    ...
    public Object generic(String interfaceClass, String methodName, Map<String, Object> parameters) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        for ( Method m : methods){
            if (methodName.equals(m.getName())) {
                invokeParamClass = m.getParameterTypes();
                method = m;
                break;
            }
        }
